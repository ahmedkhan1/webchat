  ...
  isAvailableForChat = () => {
    if (
      (this.props.workingHours &&
        this.props.workingHours?.length &&
        this.props.widgetSettings?.chat_bot?.bot_id) ||
    ...
    return (
      <div className="sc-header">
        ...
        <div className="sc-header--team-name">
          ...
          >
            <h3>
              {this.props.widgetSettings?.widget_builder?.welcome_heading}
            </h3>
            <div
              className={
                this.isAvailableForChat()
                  ? `sc-header--agent-status active ${
                      this.showMenu() ? "menu-active" : "menu-inactive"
                    }`
                  : `sc-header--agent-status inactive ${
                      this.showMenu() ? "menu-active" : "menu-inactive"
                    }`
              }
            ></div>
        ...
        <div className="sc-header--options">
          ...
          <div className={`menu-dropdown ${menuOpen ? "open" : ""}`}>
            ...
            {this.props.widgetSettings?.other_channel &&
              this.props.widgetSettings?.other_channel?.whatsapp && (
                <a
                  href={"#"}
                  className="menu-item"
                  onClick={() => {
                ...
                >
                  <img src={whatsapp} className="insta-menu" alt="WhatsApp" />{" "}
                  Continue on WhatsApp
                </a>
              )}
            {this.props.widgetSettings?.other_channel &&
              this.props.widgetSettings?.other_channel?.messenger && (
                <a
            ...
            {this.props.widgetSettings?.other_channel &&
              this.props.widgetSettings?.other_channel?.instagram && (
                <a
