...
const botResponseTemplate = (text) => {
      ...
      const responseData = 'Your feedback help us improve our service and support.<br><br>Please take a minute to rate your experience with our representative today!<br>'
    ...
    <div className="App">
     ...
     <style>{` .sc-launcher, .sc-message--dtext, .sc-header {
      ...
      {error &&
            ...
            <ErrorPage isOpen={open} handleClick={() => setOpen(!open)} clickMe={clickMe} />
      }   
    {(!loading  && !error) &&
      <Launcher
        agentProfile={{
